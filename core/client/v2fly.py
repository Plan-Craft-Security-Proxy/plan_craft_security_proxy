...
from core.receiver import V2flyProxyServerReceiver


class V2flyProxyServerClient(ProxyServerClient):
    ...
    def __init__(
        ...
        self.__receiver = V2flyProxyServerReceiver(bin_file_path, config_path, cwd)
